...
namespace Photon.Pun.Demo.PunBasics
{
    ...
    public class LoaderAnime : MonoBehaviour
    {
        ...
        [Tooltip("Radius os the loader")] public float radius = 1f;
        ...
        void Update()
        {
            ...
            if (_isAnimating)
            {
                ...
                _particleTransform.localPosition =
                    Vector3.MoveTowards(_particleTransform.localPosition, _offset, 0.5f * Time.deltaTime);
            }
        }
